...
public class Operation {
        ...
        while(data!=null){
            ...
            if(updateNum == entryCounts){
                ...
                for(int i = 0; i < fields.length; i++){
                    boolean isUpdate = Util.getYesorNo("apakah anda ingin merubah " + fields[i]);
                ...
                boolean isUpdate =  Util.getYesorNo("apakah anda yakin ingin mengupdate data tersebut");
    ...
    public static void hapusData() throws IOException {
        ...
        while(data!=null){
            ...
            if(deleteNumber == entryCounts){
                ...
                isDelete =  Util.getYesorNo("Apakah anda yakin akan menghapus?");
                isFound = true;
            }
    ...
    public static void tambahData() throws IOException {
        ...
        if(!isExist){
            ...
            boolean isTambah = Util.getYesorNo("Apakah akan ingin menambah data tersebut? ");
